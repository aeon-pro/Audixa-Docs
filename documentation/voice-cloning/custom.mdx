...
To use your new customv voice via the Web Dashboard, you can head to the [**Text to Speech Page**]('https://audixa.ai/dashboard/tts), then select Advance model, and then in the Voices menu, you can find your Custom Voice.
